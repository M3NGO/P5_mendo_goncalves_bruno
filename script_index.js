                ...
                itemData.then(function (appareil){
                    ...
                    appareil.forEach((appareilPhoto) => {
                        ...
                        let img = new Image(); // display des images
                            ...
                            img.setAttribute('onclick', 'location.href=produit.html?id=' + appareilPhoto._id)
...
let produit = localStorage.getItem('URL')
console.log(produit)


// let urlProduits = new URL((sessionStorage.ID)- location.href)
